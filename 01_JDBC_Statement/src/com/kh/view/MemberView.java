...
public class MemberView {
	...
	// alt + shift + j : 메소드 설명 주석 단축키( 매개변수와 반환형과 함께 자동완성됨) : 파란색 주석,
	//					 메소드 설명만 달아주면됨.
	...
	public void insertMember() {
		...
		// 입력받은 정보를 넘겨서 회원 추가 요청 => Controller 의 어떤 메소드를 호출하겠다
		mc.insertMember(m);
	...
	/**
	 * 사용자에게 변경할 회원의 아이디 , 변경할 정보들(비번, 이메일, 휴대폰, 주소) 입력을 받은 후
	 * 변경 요청하는 메소드
	 */
	...
	/**
	 * 사용자에게 탈퇴할 회원 아이디 + 비밀번호를 입력받은 후 삭제요청하는 메소드
	 */
	...
	/**
	 * 조회 서비스 요청 시 조회 결과가 없을 떄 보게될 화면
	...
	/**
	 * 조회 서비스 요청시 "여러행"이 조회된 결과를 받아서 보게될 화면
